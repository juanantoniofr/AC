...
def prod_escalar_serie (a, b, primer_elemento, n):
    ...
    print(f"Proceso {MPI.COMM_WORLD.Get_rank()}: vector_a = {vector_a} y vector_b = {vector_b}")
...
print(f"Proceso {mi_rango}: n_local = {n_local} y inicio_vector_local = {inicio_vector_local}")
