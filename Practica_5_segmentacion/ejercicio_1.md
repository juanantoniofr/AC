...
| 2   | `addi x11, x11, 0`        |     | IF  | -   | -   | _ID_ | EX  | MEM | _WB_ |     |     |     |      |     |     |      |     |     |     |      |         |
...
| `addi a2, a2, 5`    |     | IF  | -   | -   | _ID_ | EX  | MEM | _WB_ |     |     |     |      |     |     |     |     |     |
| `sw a2, 0(a1)`      |     |     | IF  | IF  | IF   | -   | -   | _ID_ | EX  | MEM | WB  |      |     |     |     |     |     |
| `addi a1, a1, 4`    |     |     |     |     |      | IF  | IF  | IF   | ID  | EX  | MEM | _WB_ |     |     |     |     |     |
| `blt a1, a4, bucle` |     |     |     |     |      |     |     |      | IF  | -   | -   | _ID_ | EX  | MEM | WB  |     |     |
...
| 3   | `addi a4, a1, 400`        |     |     | IF  | IF  | IF   | -   | -   | _ID_ | EX  | MEM | WB  |      |      |     |     |         |      |     |
| 4   | `lw a2, 0(a1)`            |     |     |     |     |      |     |     | IF   | ID  | EX  | MEM | _WB_ |      |     |     |         |      |     |
| 5   | `addi a1, a1, 4`          |     |     |     |     |      |     |     |      | IF  | ID  | EX  | MEM  | _WB_ |     |     |         |      |     |
| 6   | `addi a2, a2, 5`          |     |     |     |     |      |     |     |      |     | IF  | ID  | EX   | MEM  | WB  |     |         |      |     |
| 7   | `sw a2, 0(a1)`            |     |     |     |     |      |     |     |      |     |     | IF  | -    | -    | ID  | EX  | MEM     | _WB_ |     |
