...
# A. Se produce un deadlock porque todos los procesos están esperando a recibir un mensaje antes de enviar el suyo. Para evitarlo, podemos hacer que el proceso 0 envíe su mensaje primero, y luego cada proceso envíe su mensaje después de recibir el mensaje del proceso anterior.
