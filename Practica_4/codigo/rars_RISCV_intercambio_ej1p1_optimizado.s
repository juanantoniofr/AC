...
# RISCV_intercambio_ej1p1_optimizado.c:9:   for (j=0; i<N; i++)
	li	s2,0		
# RISCV_intercambio_ej1p1_optimizado.c:9:   for (j=0; i<N; i++)
	j	.L2		
.L5:
# RISCV_intercambio_ej1p1_optimizado.c:10: 	for (i=0; j<N;j++)
	li	s1,0		
# RISCV_intercambio_ej1p1_optimizado.c:10: 	for (i=0; j<N;j++)
	j	.L3		
.L4:
# RISCV_intercambio_ej1p1_optimizado.c:11: 		A[i][j]= 1917;
	la	a4,A	
	slli	a5,s1,5	
	add	a5,a5,s2	
	slli	a5,a5,2	
...
# RISCV_intercambio_ej1p1_optimizado.c:9:   for (j=0; i<N; i++)
	li	a5,31		
	ble	s1,a5,.L5	
# RISCV_intercambio_ej1p1_optimizado.c:12:   return(0);
	li	a5,0		
# RISCV_intercambio_ej1p1_optimizado.c:13: }
	mv	a0,a5	
